...
#ifndef MUXSDKKALTURA_SWIFT_H
#define MUXSDKKALTURA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MUXSDKKaltura",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC13MUXSDKKaltura19MUXSDKPlayerBinding")
...
SWIFT_CLASS("_TtC13MUXSDKKaltura11MUXSDKStats")
...
/// \param player A PlayKit Player to monitor
///
/// \param playerName A name for this instance of the player
///
...
///
/// \param beaconDomain Domain to send tracking data to, if you want to use a custom beacon domain. Optional.
///
///
/// returns:
/// An instance of MUXSDKPlayerBinding or null
